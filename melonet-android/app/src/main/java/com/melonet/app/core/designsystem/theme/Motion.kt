...
object MeloMotion {
    ...
    val playerExpandTween = tween<IntOffset>(durationMillis = playerExpandMs, easing = FastOutSlowInEasing)
    val playerFadeTween = tween<Float>(durationMillis = playerExpandMs, easing = FastOutSlowInEasing)
